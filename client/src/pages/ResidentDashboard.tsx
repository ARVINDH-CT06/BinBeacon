...
export default function ResidentDashboard() {
  ...
  const renderFeatureModal = () => {
    ...
    const featureComponents = {
      ...
      history: <History onClose={closeFeature} />,
      overflow: <OverflowReporting onClose={closeFeature} />,
      connect: <Connect onClose={closeFeature} />,
      feedback: <Feedback onClose={closeFeature} onEmergency={handleEmergency} />
    };
    ...
    <div className="min-h-screen p-4">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        >
          ...
          <h3 className="text-xl font-semibold mb-2">{t('garcar-tracker')}</h3>
        ...
        >
          ...
          <h3 className="text-xl font-semibold mb-2">{t('overflow-reporting')}</h3>
          <p className="text-sm text-muted-foreground group-hover:text-primary-foreground">
            {t('report-overflow')}
          </p>
        </button>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="text-left">
              <h3 className="text-xl font-semibold mb-2">{t('feedback')} & {t('emergency')}</h3>
